import type { WarehouseHospitalClinicalOutcome } from "./flatten";

export interface ClinicalOutcomeVerificationResult {
  passed: boolean;
...
export function verifyHospitalClinicalOutcomes(
  records: WarehouseHospitalClinicalOutcome[],
): ClinicalOutcomeVerificationResult {
